...
var fileDescriptor_3e1876930beede27 = []byte{
	...
	0x8b, 0x8b, 0xcb, 0xf3, 0x8b, 0x52, 0x24, 0x98, 0xc1, 0x12, 0x70, 0xbe, 0x92, 0x23, 0x17, 0x0b,
	0xd8, 0x34, 0x7e, 0x2e, 0xe6, 0xf8, 0xcc, 0x14, 0xb0, 0x61, 0x3c, 0x41, 0x4c, 0x9e, 0x29, 0x70,
	0xe3, 0x99, 0xb0, 0x19, 0xcf, 0x8c, 0x64, 0xbc, 0x91, 0x15, 0x17, 0xbb, 0x1f, 0xc4, 0x79, 0x42,
	0xfa, 0x5c, 0x5c, 0xce, 0x45, 0xa9, 0x89, 0x25, 0xa9, 0x60, 0x33, 0x05, 0xf4, 0x60, 0xbe, 0x80,
	0xba, 0x59, 0x8a, 0x17, 0x2e, 0x02, 0xe2, 0x2a, 0x31, 0x38, 0xd9, 0x9f, 0x78, 0x24, 0xc7, 0x78,
	...
	0xae, 0x7e, 0x66, 0x71, 0x71, 0x46, 0xbe, 0x6e, 0x5e, 0x26, 0x84, 0xa1, 0x9f, 0x58, 0x90, 0x09,
	0x0b, 0x9f, 0x24, 0x36, 0x70, 0x00, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x54, 0x6d, 0x3f,
	0xd5, 0x39, 0x01, 0x00, 0x00,
}
...
func (m *User) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.XId) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintNinshou(dAtA, i, uint64(len(m.XId)))
		i += copy(dAtA[i:], m.XId)
	}
	if len(m.Name) > 0 {
		dAtA[i] = 0x12
